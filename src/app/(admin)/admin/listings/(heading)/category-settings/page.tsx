  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-2 text-gray-800">검색창 표시 설정</h1>
        <p className="text-gray-600 mb-8">사용자 페이지에 표시될 검색 필터를 선택하세요.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {Object.keys(settingLabels).map((key) => (
            ...
            >
              <span className="font-medium text-gray-700">{settingLabels[key]}</span>
